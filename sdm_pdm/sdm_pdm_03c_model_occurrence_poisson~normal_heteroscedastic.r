...
###
### source('C:/Kaji/R/andropogon_integratedEcology/sdm_pdm/sdm_pdm_03c_model_occurrence_poisson~normal_heteroscedastic.r')
### 
#############
### setup ###
#############
...
###########################
	...
	out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_poisson~normal_heteroscedastic_', preds_filename, '_[bias~quad_ia]]', ifelse(trial, '_TRIAL', ''), '/')
	previous_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_poisson~normal_homoscedastic_', preds_filename, '_[bias~quad_ia]]', ifelse(trial, '_TRIAL', ''), '/')
	...
	# out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_poisson~normal_heteroscedastic_', preds_filename, '_[bias~quad]]', ifelse(trial, '_TRIAL', ''), '/')
	# previous_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_poisson~normal_homoscedastic_', preds_filename, '_[bias~quad]]', ifelse(trial, '_TRIAL', ''), '/')
	...
	# out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_poisson~normal_heteroscedastic_', preds_filename, '_[bias~ia]]', ifelse(trial, '_TRIAL', ''), '/')
	# previous_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_poisson~normal_homoscedastic_', preds_filename, '_[bias~ia]]', ifelse(trial, '_TRIAL', ''), '/')
	# formula_occs_bias <- ~ 1 + area_km2_log10 + n_poaceae_log10p1 + area_km2_log10:n_poaceae_log10p1 # sampling bias for AG records

	# out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_poisson~normal_heteroscedastic_', preds_filename, '_[bias~linear]]', ifelse(trial, '_TRIAL', ''), '/')
	# previous_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_poisson~normal_homoscedastic_', preds_filename, '_[bias~linear]]', ifelse(trial, '_TRIAL', ''), '/')
	# formula_occs_bias <- ~ 1 + area_km2_log10 + n_poaceae_log10p1 # sampling bias for AG records

	# out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_poisson~normal_heteroscedastic_', preds_filename, '_[bias~area]]', ifelse(trial, '_TRIAL', ''), '/')
	# formula_occs_bias <- ~ n_poaceae_log10p1 # sampling bias for AG records
	# previous_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_poisson~normal_homoscedastic_', preds_filename, '_[bias~area]]', ifelse(trial, '_TRIAL', ''), '/')
	# formula_occs_bias <- ~ 1 + area_km2_log10 # sampling bias for AG records

	# out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_poisson~normal_heteroscedastic_', preds_filename, '_[bias~area^2]]', ifelse(trial, '_TRIAL', ''), '/')
	# previous_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_poisson~normal_homoscedastic_', preds_filename, '_[bias~area^2]]', ifelse(trial, '_TRIAL', ''), '/')
	# formula_occs_bias <- ~ area_km2_log10 + I(area_km2_log10^2) # sampling bias for AG records

	# out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_poisson~normal_heteroscedastic_', preds_filename, '_[bias~poa]]', ifelse(trial, '_TRIAL', ''), '/')
	# formula_occs_bias <- ~ n_poaceae_log10p1 # sampling bias for AG records
	# previous_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_poisson~normal_homoscedastic_', preds_filename, '_[bias~poa]]/')
	# formula_occs_bias <- ~ 1 + n_poaceae_log10p1 # sampling bias for AG records

	# out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_poisson~normal_heteroscedastic_', preds_filename, '_[bias~poa^2]]', ifelse(trial, '_TRIAL', ''), '/')
	# previous_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_poisson~normal_homoscedastic_', preds_filename, '_[bias~poa^2]]', ifelse(trial, '_TRIAL', ''), '/')
	# formula_occs_bias <- ~ n_poaceae_log10p1 + I(n_poaceae_log10p1^2) # sampling bias for AG records
...
#############
	...
	alpha_occs_inits <- hammer_extract(previous_chains, 'alpha_occs', j = TRUE, stat = 'mean')
	...
	inits <- list(
		...
		lambda_resp_curves_mu = response_curves_occs_mu_inits
	...
	monitors_coeffs_single_index <- c('beta_occs_mu', 'alpha_occs', 'beta_occs_sigma')
	...
	monitors_resp_curves <- c(
		'response_curves_occs_mu', 'response_curves_occs_sigma', 'response_curves_occs_bias'
	)
