...
###
### source('C:/Kaji/R/andropogon_integratedEcology/sdm_pdm/sdm_pdm_03b_model_occurrence_zip~normal_homoscedastic.r')
### 
#############
### setup ###
#############
...
###########################
	...
	# out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_zip~normal_homoscedastic_', preds_filename, '_[bias~quad_ia]]', ifelse(trial, '_TRIAL', ''), '/')
	...
	# out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_zip~normal_homoscedastic_', preds_filename, '_[bias~quad]]', ifelse(trial, '_TRIAL', ''), '/')
	...
	# out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_zip~normal_homoscedastic_', preds_filename, '_[bias~ia]]', ifelse(trial, '_TRIAL', ''), '/')
	...
	# out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_zip~normal_homoscedastic_', preds_filename, '_[bias~linear]]', ifelse(trial, '_TRIAL', ''), '/')
	...
	# out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_zip~normal_homoscedastic_', preds_filename, '_[bias~area]]', ifelse(trial, '_TRIAL', ''), '/')
	...
	# out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_zip~normal_homoscedastic_', preds_filename, '_[bias~area^2]]', ifelse(trial, '_TRIAL', ''), '/')
	...
	# out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_zip~normal_homoscedastic_', preds_filename, '_[bias~poa]]', ifelse(trial, '_TRIAL', ''), '/')
	# formula_occs_bias <- ~ n_poaceae_log10p1 # sampling bias for AG records
	...
	# out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_zip~normal_homoscedastic_', preds_filename, '_[bias~poa^2]]', ifelse(trial, '_TRIAL', ''), '/')
...
#############
	...
	inits <- list(
		...
		beta_occs_pzero = rep(-2, data_occs$n_terms_occs), # occurrence ~ environment coefficients (including intercept)
	...
	monitors_coeffs_single_index <- c('p', 'beta_occs_mu', 'alpha_occs', 'beta_occs_pzero')
