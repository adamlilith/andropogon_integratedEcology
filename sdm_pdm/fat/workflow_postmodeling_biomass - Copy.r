...
workflow_postmodeling_biomass <- function(descrip, formula_biomass_mu, homoscedastic, zero_inflated, crossvalidate, pred_vect_nam, pred_vect_conus, out_dir) {
	...
	say('BIOMASS: future maps', level = 2)
		...
		for (fut in futs) {
			...
			response_var <- paste0('mu_biomass_county_', fut)
	...
	if (crossvalidate) {
		...
		for (k in 1:max_k_folds) {
			...
			fold_constants$n_counties_20th_cent <- 1 # faster!
			...
			fold_inits$log_biomass_county_mu_sq <- fold_inits$log_biomass_county_mu_sq[1]
			fold_inits$log_biomass_county_mu_ssp245_2041_2070 <- fold_inits$log_biomass_county_mu_ssp245_2041_2070[1]
			fold_inits$log_biomass_county_mu_ssp245_2071_2100 <- fold_inits$log_biomass_county_mu_ssp245_2071_2100[1]
			fold_inits$log_biomass_county_mu_ssp370_2041_2070 <- fold_inits$log_biomass_county_mu_ssp370_2041_2070[1]
			fold_inits$log_biomass_county_mu_ssp370_2071_2100 <- fold_inits$log_biomass_county_mu_ssp370_2071_2100[1]
			fold_inits$log_biomass_county_mu_thirties <- fold_inits$log_biomass_county_mu_thirties[1]
			fold_inits$log_biomass_county_mu_fifties <- fold_inits$log_biomass_county_mu_fifties[1]
