...
###
### source('C:/Kaji/R/andropogon_integratedEcology/sdm_pdm/sdm_pdm_05a_model_occs_biomass~mvn.r')
### 
#############
### setup ###
#############
...
#############
	...
	chains_occs <- readRDS('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_poisson~normal~bio1^2_bio12^2_bio15^2_[bias~1]]/chains.rds')
	...
	monitors_coeffs_single_index <- c('beta_occs', 'alpha_occs', 'beta_biomass', 'sigmas')
...
say('#################################################')
	...
	descrip <- 'occurrence ~ Poisson(MVN), biomass ~ gamma(MVN)'
