...
###########################
	...
	out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_zip~normal_heteroscedastic_bio1^2_bio12^2_bio15^2_[bias~1]]', ifelse(trial, '_TRIAL', ''), '/')
	previous_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_zip~normal_homoscedastic_', preds_filename, '_[bias~1]]', ifelse(trial, '_TRIAL', ''), '/')
