...
###
### source('C:/Kaji/R/andropogon_integratedEcology/sdm_pdm/sdm_pdm_05a_model_biomass_fx_of_environment_lognormal_homoscedastic_preliminary.r')
### 
### CONTENTS ###
### setup ###
### model ###
...
#####################
	...
	inits <- list(
		...
		biomass_sigma = init_biomass_sigma,
	...
	monitors_coeffs <- c('beta_mu_biomass', 'biomass_sigma', 'site_mu_hat_biomass')
	monitors_simple <- c('beta_mu_biomass', 'biomass_sigma')
...
say('###########################')
	...
	combo <- (caterpillars[[1]] + caterpillars[[2]]) / caterpillars[[3]]
