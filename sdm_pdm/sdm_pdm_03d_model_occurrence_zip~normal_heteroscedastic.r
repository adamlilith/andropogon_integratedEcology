...
###########################
	...
	# out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_zip~normal_heteroscedastic_bio1^2_bio12^2_bio15^2_[bias~quad_ia]]', ifelse(trial, '_TRIAL', ''), '/')
	...
	# out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_zip~normal_heteroscedastic_bio1^2_bio12^2_bio15^2_[bias~quad]]', ifelse(trial, '_TRIAL', ''), '/')
	...
	# out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_zip~normal_heteroscedastic_bio1^2_bio12^2_bio15^2_[bias~ia]]', ifelse(trial, '_TRIAL', ''), '/')
	# formula_occs_bias <- ~ 1 + area_km2_log10 + n_poaceae_log10p1 +  area_km2_log10:n_poaceae_log10p1 # sampling bias for AG records

	out_dir <- paste0('./outputs_loretta/integrated_sdm_pdm/models_occurrence/[occs_zip~normal_heteroscedastic_bio1^2_bio12^2_bio15^2_[bias~linear]]', ifelse(trial, '_TRIAL', ''), '/')
...
#############
	...
	inits <- list(
		...
		beta_occs_sigma = beta_occs_inits, # occurrence sd ~ environment coefficients (including intercept)
	...
	monitors_coeffs_single_index <- c('beta_occs_mu', 'beta_occs_sigma', 'beta_occs_pzero', 'alpha_occs')
	...
	monitors_resp_curves <- c(
		'response_curves_occs_mu','response_curves_occs_sigma', 'response_curves_occs_bias', 'response_curves_occs_pzero'
	)
