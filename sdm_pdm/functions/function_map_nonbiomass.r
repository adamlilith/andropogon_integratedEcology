...
#' @param core_quant Quantile used to delineate core from non-core.
map_nonbiomass_trait <- function(
	...
	if (plot_range_core) range_core <- delineate_range_core(pred_vect_display, column = 'N_ag_county_sq', core_quant = core_quant)
