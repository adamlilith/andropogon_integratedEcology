...
#'
prepare_biomass_data <- function(formula_biomass, log_precip, n_response_curve_values = 200, calib = TRUE) {
	...
	list(
		...
		site_biomass_sd = site_biomass_sd,		# sd of site-level biomass

		across_sites_biomass_mean = across_sites_biomass_mean,	# mean biomass across sites
		across_sites_biomass_sd = across_sites_biomass_mean,	# s.d. across sites
