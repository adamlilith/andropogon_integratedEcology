...
###
### source('C:/Kaji/R/andropogon_integratedEcology/sdm_pdm/sdm_pdm_03b_model_occurrence_zip~normal_homoscedastic_slim.r')
### 
#############
### setup ###
#############
...
#############
	...
	beta_occs_pzero_inits <- rep(-1, data_occs_pzero$n_terms_occs)
