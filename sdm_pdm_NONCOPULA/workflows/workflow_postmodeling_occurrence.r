...
#'
#' formula_occs,formula_psi,formula_occs_bias Formulae for occurrences, sigma, probability of zero-inflation, and  occurrence bias
#' homoscedastic If `TRUE`, then do not analyze behavior of sigma
