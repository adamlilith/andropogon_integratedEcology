...
map_psi <- function(
	...
	range_core_present <- delineate_range_core(pred_vect_display, column = response_var, ag_core_quant = 0.95, rule = '>=')
	...
	map <- ggplot() +
		...
		layer_spatial(range_core_present, color = 'yellow', fill = NA, linewidth = 0.8) +
