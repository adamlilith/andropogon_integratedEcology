...
# say('############################################################################')
	...
	ag_vect <- vect('./andropogon_gerardi_occurrences_with_environment_1961_2020_climatena.gpkg')
...
say('#########################################################')
	...
	write.csv(results, './simple_quadratic_models_on_ratio_of_ag_to_poaceae.csv', row.names = FALSE)
