...
###
### source('C:/Ecology/R/andropogon_integratedEcology/sdm/sdm_03_nonintegrated_model_maps.r')
### source('C:/Subarashi/R/andropogon_integratedEcology/sdm/sdm_03_nonintegrated_model_maps.r')
###
### CONTENTS ###
### setup ###
...
say('####################################################################################')
	...
	### sample site data
	pheno_sites <- read_xlsx('./data/!plant_sitelevel_data_11NOV2024 - Google Sheets [aggregated by Erica].xlsx', sheet = 'plantmaster_bysite_19NOV2024')
...
say('####################################################################################')
	...
	in_out_dir <- './sdm_[nmixture]_[pseudoabsences_0.99]_[bio1^2_bio12^2_bio15^2]_[priors_ddnorm]/'
