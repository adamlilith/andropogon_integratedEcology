...
#############
	...
	#######################
		...
		climate_predictor_names <- c('bio1', 'bio12', 'bio15') # set for multivariate analyses, chosen based on simple models and collinearity
	...
	# out_dir <- paste0('./sdm_[TEMP]/')
	# out_dir <- paste0('./sdm_[nmixture]_[pseudoabsences_', psa_quant, ']_[', paste(predictor_names, collapse = '_'), '_quad_ia]_[priors_ddnorm]', ifelse(trial, '_TRIAL', ''), '/')
	# out_dir <- paste0('./sdm_[nmixture]_[pseudoabsences_', psa_quant, ']_[bio1^2_bio12^2_bio15^2_bio1xbio12_bio1xbio12]_[priors_ddnorm]', ifelse(trial, '_TRIAL', ''), '/')
	# out_dir <- paste0('./sdm_[nmixture]_[pseudoabsences_', psa_quant, ']_[bio1^2_bio12^2_bio15^2_bio1xbio12xbio15]_[priors_ddnorm]', ifelse(trial, '_TRIAL', ''), '/')
	# out_dir <- paste0('./sdm_[nmixture]_[pseudoabsences_', psa_quant, ']_[bio1^2_bio12^2_bio15^2_bio1xbio12]_[priors_ddnorm]', ifelse(trial, '_TRIAL', ''), '/')
	# out_dir <- paste0('./sdm_[nmixture]_[pseudoabsences_', psa_quant, ']_[bio1^2_bio12^2_bio15^2_bio1xbio12xbio15]_[priors_ddnorm]', ifelse(trial, '_TRIAL', ''), '/')
	# out_dir <- paste0('./sdm_[nmixture]_[pseudoabsences_', psa_quant, ']_[bio1^2_bio12^2_bio15^2_bio1xbio12_bio1xbio15_bio12xbio15]_[priors_ddnorm]', ifelse(trial, '_TRIAL', ''), '/')
	out_dir <- paste0('./sdm_[nmixture]_[pseudoabsences_', psa_quant, ']_[bio1^2_bio12^2_bio15^2_bio12xbio15]_[priors_ddnorm]', ifelse(trial, '_TRIAL', ''), '/')
	dirCreate(out_dir)
...
say(date(), post = 1)
	...
	### load AG data
	ag_vect_sq <- vect('./data/andropogon_gerardi_occurrences_with_environment_1961_2020_climatena.gpkg')
	ag_vect_ssp245_2041_2070 <- vect('./data/andropogon_gerardi_occurrences_with_environment_ensemble_8GCMs_ssp245_2041_2070_climatena.gpkg')
	ag_vect_ssp245_2071_2100 <- vect('./data/andropogon_gerardi_occurrences_with_environment_ensemble_8GCMs_ssp245_2071_2100_climatena.gpkg')
	ag_vect_ssp370_2041_2070 <- vect('./data/andropogon_gerardi_occurrences_with_environment_ensemble_8GCMs_ssp370_2041_2070_climatena.gpkg')
	ag_vect_ssp370_2071_2100 <- vect('./data/andropogon_gerardi_occurrences_with_environment_ensemble_8GCMs_ssp370_2071_2100_climatena.gpkg')
	...
	# ag_vect_soil <- vect('./data/andropogon_gerardi_occurrences_with_environment_soil.gpkg')
