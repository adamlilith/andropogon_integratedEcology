...
###
### source('C:/Kaji/R/andropogon_integratedEcology/sdm_pdm_for_sem/sem_02_exploratory_data_analysis.r')
###
### CONTENTS ###
### setup ###
...
# 	dirCreate('./outputs_loretta/sdm_pdm_for_sem')

# 	sites <- readRDS('./data_from_loretta/sem_00_merged_site_data_with_climate/sites.rds')
# 	biomass <- readRDS('./data_from_loretta/sem_00_merged_site_data_with_climate/biomass.rds')
# 	morpho_phys <- readRDS('./data_from_loretta/sem_00_merged_site_data_with_climate/morpho_phys.rds')
...
# 	ggsave(plots, filename = './outputs_loretta/sdm_pdm_for_sem/biomass_trait_histograms.png', width = 8, height = 8, dpi = 300, bg = 'white')
...
# 	ggsave(plots, filename = './outputs_loretta/sdm_pdm_for_sem/morphology_trait_histograms.png', width = 16, height = 12, dpi = 300, bg = 'white')
...
# say('#####################################')
	...
	# for (trait in unique(long$trait)) {
		...
		# ggsave(plots, filename = paste0('./outputs_loretta/sdm_pdm_for_sem/trait_histograms_by_site_', tolower(trait), '.png'), width = 8, height = 8, dpi = 300, bg = 'white')
...
# 		occs <- vect('./outputs_loretta/sdm_pdm_for_sem/andropogon_gerardi_occurrences_with_environment_1961_2020_for_integration.gpkg')
...
# 		ggsave(combo, filename = './outputs_loretta/sdm_pdm_for_sem/correlations_between_covariates_sites_and_counties_with_poaceae.svg', height = 5, width = 12, dpi = 600)

# say('##############################################################')
# say('### univariate plots of each phenotypic trait by covariate ###')
# say('##############################################################')

# 	out_dir <- './outputs_loretta/sdm_pdm_for_sem/univariate_plots_of_traits'
# 	dirCreate(out_dir)
...
# 	### setup
# 	out_dir <- './outputs_loretta/sdm_pdm_for_sem'
# 	dirCreate(out_dir)
...
# 	ag <- vect('./outputs_loretta/sdm_pdm_for_sem/andropogon_gerardi_occurrences_with_environment_1961_2020_for_integration.gpkg')
...
# 	fwrite(evals, './outputs_loretta/sdm_pdm_for_sem/presence_absence_glm.csv')
