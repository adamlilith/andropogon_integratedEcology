...
map_pzero <- function(
	...
	# extent
	site_vect <- data_traits[[paste0('site_vect_biomass')]]
	...
	if (plot_range_core) range_core <- delineate_range_core(pred_vect_display, column = response_var, ag_core_quant)

	# get range of values for plotting
	vars <- c(
		paste0('pzero_biomass_county_sq')#,
		# paste0('pzero_county_ssp245_2041_2070'),
		# paste0('pzero_county_ssp245_2071_2100'),
		# paste0('pzero_county_ssp370_2041_2070'),
		# paste0('pzero_county_ssp370_2071_2100')
	)
